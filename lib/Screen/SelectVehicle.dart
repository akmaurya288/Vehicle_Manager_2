...
class SelectVehice extends StatefulWidget {
  @override
  _SelectVehiceState createState() => _SelectVehiceState();
}

class _SelectVehiceState extends State<SelectVehice> {
...
//          ],
          ...
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context,int index){
              return GestureDetector(child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              Text("Modle No.:",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                ...
                onTap:()=>_moveToLastScreen(model[index].vehicleID),
              );
            },
          ),
        ),
  ...
  _moveToLastScreen(int vehicleID) async{
    if(vehicleID==null)
      vehicleID=-1;
